...
insert into Valuta (Naziv,Naziv2,IsoAlpha3,Oznaka) values 
	...
	('amerièki dolar','US Dollar','USD','840'),
	('euro','Euro','EUR','978'),
	('kvanza','Kwanza','AOA','973'),
	('istoènokaripski dolar','East Caribbean Dollar','XCD','951'),
	...
	('èeška kruna','Czech Koruna','CZK','203'),
	('èileanski pezo','Chilean Peso','CLP','152'),
	...
	('malavi kvaèa','Malawi Kwacha','MWK','454'),
	...
	('meksièki pezo','Mexican Peso','MXN','484'),
	('kjat','Kyat','MMK','104'),
	...
	('naira','Naira','NGN','566'),
	('kordoba oro','Córdoba Oro','NIO','558'),
	...
	('solomonskootoèni dolar','Solomon Islands Dollar','SBD','090'),
	...
	('dong','Dong','VND','704'),
	('zambijska kvaèa','Zambian Kwacha','ZMW','967'),
...
insert into Drzava (Naziv,NazivEng,IsoAlpha2,IsoAlpha3,Oznaka,ValutaId,IndEu) values
	...
	('Maðarska','Hungary','HU','HUN','348',91,1),
	('Malta','Malta','MT','MLT','470',5,1),
	('Nizozemska','Netherlands','NL','NLD','528',5,1),
	('Njemaèka','Germany','DE','DEU','276',5,1),
	...
	('Slovaèka','Slovakia','SK','SVK','703',5,1),
