...
insert into Valuta (Naziv,Naziv2,IsoAlpha3,Oznaka) values 
	...
	('lek','Lek','ALL','008'),
	('alžirski dinar','Algerian Dinar','DZD','012'),
	('američki dolar','US Dollar','USD','840'),
	('euro','Euro','EUR','978'),
	('kvanza','Kwanza','AOA','973'),
	('istočnokaripski dolar','East Caribbean Dollar','XCD','951'),
	...
	('azerbajdžanski manat','Azerbaijan Manat','AZN','944'),
	...
	('češka kruna','Czech Koruna','CZK','203'),
	('čileanski pezo','Chilean Peso','CLP','152'),
	('danska kruna','Danish Krone','DKK','208'),
	('dominikanski pezo','Dominican Peso','DOP','214'),
	('džibutski franak','Djibouti Franc','DJF','262'),
	...
	('fidžijski dolar','Fiji Dollar','FJD','242'),
	...
	('hongkonški dolar','Hong Kong Dollar','HKD','344'),
	('indijska rupija','Indian Rupee','INR','356'),
	('rupija','Rupiah','IDR','360'),
	('irački dinar','Iraqi Dinar','IQD','368'),
	('iranski rijal','Iranian Rial','IRR','364'),
	('islandska kruna','Iceland Krona','ISK','352'),
	('novi izraelski šekel','New Israeli Sheqel','ILS','376'),
	('jamajčanski dolar','Jamaican Dollar','JMD','388'),
	('jen','Yen','JPY','392'),
	('jemenski rijal','Yemeni Rial','YER','886'),
	('jordanski dinar','Jordanian Dinar','JOD','400'),
	('južnosudanska funta','South Sudanese Pound','SSP','728'),
	('rand','Rand','ZAR','710'),
	...
	('tenge','Tenge','KZT','398'),
	('kenijski šiling','Kenyan Shilling','KES','404'),
	...
	('švicarski franak','Swiss Franc','CHF','756'),
	('malgaški arijari','Malagasy Ariary','MGA','969'),
	('forinta','Forint','HUF','348'),
	('pataka','Pataca','MOP','446'),
	('malavi kvača','Malawi Kwacha','MWK','454'),
	...
	('meksički pezo','Mexican Peso','MXN','484'),
	('kjat','Kyat','MMK','104'),
	...
	('naira','Naira','NGN','566'),
	('kordoba oro','Cordoba Oro','NIO','558'),
	('norveška kruna','Norwegian Krone','NOK','578'),
	...
	('sejšelska rupija','Seychelles Rupee','SCR','690'),
	('leone','Leone','SLE','925'),
	...
	('solomonskootočni dolar','Solomon Islands Dollar','SBD','090'),
	('somalijski šiling','Somali Shilling','SOS','706'),
	...
	('dobra','Dobra','STN','930'),
	('Šrilanska rupija','Sri Lanka Rupee','LKR','144'),
	('Švedska kruna','Swedish Krona','SEK','752'),
	('somoni','Somoni','TJS','972'),
	('baht','Baht','THB','764'),
	('novotajvanski dolar','New Taiwan Dollar','TWD','901'),
	('tanzanijski šiling','Tanzanian Shilling','TZS','834'),
	('paanga','Paanga','TOP','776'),
	('trinidadtobaški dolar','Trinidad and Tobago Dollar','TTD','780'),
	...
	('ugandski šiling','Uganda Shilling','UGX','800'),
	...
	('dong','Dong','VND','704'),
	('zambijska kvača','Zambian Kwacha','ZMW','967'),
...
insert into Drzava (Naziv,NazivEng,IsoAlpha2,IsoAlpha3,Oznaka,ValutaId,IndEu) values
	...
	('Mađarska','Hungary','HU','HUN','348',91,1),
	('Malta','Malta','MT','MLT','470',5,1),
	('Nizozemska','Netherlands','NL','NLD','528',5,1),
	('Njemačka','Germany','DE','DEU','276',5,1),
	...
	('Slovačka','Slovakia','SK','SVK','703',5,1),
	('Slovenija','Slovenia','SI','SVN','705',5,1),
	('Srbija ','Serbia ','RS','SRB','688',128,0),
	('Španjolska','Spain','ES','ESP','724',5,1),
	('Švedska','Sweden','SE','SWE','752',134,1),
	('Kosovo','Kosovo','XK','XKV','999',5,0)
